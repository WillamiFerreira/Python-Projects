...
def calcular():
    global todos_valores
    resuldado = eval(todos_valores)

    valor_texto.set(str(resuldado))
...
b_4.place(x=0, y=52)
b_5 = Button(frame_corpo, text="8", width=5, height=2, bg=cor4, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE,  command= lambda: entrar_valores('5'))
b_5.place(x=59, y=52)
...
b_1 = Button(frame_corpo, text="0", width=11, height=2, bg=cor4, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE,  command= lambda: entrar_valores('0'))
b_1.place(x=0, y=208)
b_2 = Button(frame_corpo, text=".", width=5, height=2, bg=cor4, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE,  command= lambda: entrar_valores('.'))
b_2.place(x=119, y=208)
b_3 = Button(frame_corpo, text="=", width=5, height=2, bg=cor5, fg=cor2, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE, command=calcular)
b_3.place(x=178, y=208)
